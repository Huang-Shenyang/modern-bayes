...
Running average plots for 200 iterations are shown above, and they show that 200 iterations is not long enough as the running averages still do not seem to have converged.
...
Running average plots for 10000 iterations are shown above, and they suggest that the samplers still have not converged (see the unstable tail of $z_12$).
